//
// Drop in copy of original Priority Queue from JDK with two differences:
// removeAt() is now package private (I need it directly ...)
// queue can now be accessed (via package privacy) (I need it for efficiency...)
//
...
public class MyPriorityQueue<E> extends AbstractQueue<E>
    ...
    static final class MyPriorityQueueSpliterator<E> implements Spliterator<E> {
        ...
        MyPriorityQueueSpliterator(MyPriorityQueue<E> pq, int origin, int fence,
        ...
        public MyPriorityQueueSpliterator<E> trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid) ? null :
                new MyPriorityQueueSpliterator<E>(pq, lo, index = mid,
                                                expectedModCount);
        }
