	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 1; i <= 10; i++) {
			...
			for (int j = 0; j < avgC; j++) {
				final DocumentProvider<String> documentProvider = new TWCLDAPaperDocumentGenerator(random);
				holdOutSplitter[0] = new HoldOutSplitter<String>(
						random, documentProvider, 0.1, 0);
