...
public class EachMoviePerplexityPerOneUserMovie extends
	...
	public EachMoviePerplexityPerOneUserMovie(Random random, int gibbsIterations, boolean fast) {
...
//	}
	...
	public static void main(String[] args) throws IOException {
		new EachMoviePerplexityPerOneUserMovie(new Random(42), 300, true).run(20, 1);
	}	
}
