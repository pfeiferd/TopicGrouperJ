...
public class ReutersLowMemTGPChangeDocsExp extends ReutersTGPChangeDocsExp {
	public ReutersLowMemTGPChangeDocsExp() {
	}
	...
	public static void main(String[] args) {
		new ReutersLowMemTGPChangeDocsExp().runExperiment(new Random(43), 10,
				15);
	}
}
