...
public class APExtractTGLRPerplexityExperiment extends
		APExtractTGPerplexityExperiment {
	public APExtractTGLRPerplexityExperiment() {
	}
	...
	public static void main(String[] args) {
		new APExtractTGLRPerplexityExperiment().run();
