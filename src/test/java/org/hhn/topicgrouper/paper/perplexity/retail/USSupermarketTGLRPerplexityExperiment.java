...
public class USSupermarketTGLRPerplexityExperiment extends
		USSupermarketTGPerplexityExperiment {
	public USSupermarketTGLRPerplexityExperiment() {
	}
	...
	public static void main(String[] args) {
		new USSupermarketTGLRPerplexityExperiment().run();
